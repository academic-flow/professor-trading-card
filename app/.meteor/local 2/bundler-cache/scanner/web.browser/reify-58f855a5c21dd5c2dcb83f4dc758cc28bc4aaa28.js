module.export({default:()=>AutoValueRunner});let clone;module.link('clone',{default(v){clone=v}},0);let getParentOfKey;module.link('../utility/index.js',{getParentOfKey(v){getParentOfKey=v}},1);
