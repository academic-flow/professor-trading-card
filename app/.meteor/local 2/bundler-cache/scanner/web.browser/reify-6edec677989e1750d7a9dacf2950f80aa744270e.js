let validateDocument;module.link('./validation/validateDocument.js',{default(v){validateDocument=v}},0);let validateField;module.link('./validation/validateField.js',{default(v){validateField=v}},1);
