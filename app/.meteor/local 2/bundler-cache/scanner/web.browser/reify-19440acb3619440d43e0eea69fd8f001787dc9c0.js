module.export({sortAutoValueFunctions:()=>sortAutoValueFunctions});let AutoValueRunner;module.link('./AutoValueRunner.js',{default(v){AutoValueRunner=v}},0);let getPositionsForAutoValue;module.link('./getPositionsForAutoValue.js',{default(v){getPositionsForAutoValue=v}},1);
