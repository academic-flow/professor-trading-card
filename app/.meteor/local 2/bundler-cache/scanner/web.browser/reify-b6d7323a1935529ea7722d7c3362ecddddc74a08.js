module.export({default:()=>getPositionsForAutoValue});let MongoObject;module.link('mongo-object',{default(v){MongoObject=v}},0);let getLastPartOfKey,getParentOfKey;module.link('../utility/index.js',{getLastPartOfKey(v){getLastPartOfKey=v},getParentOfKey(v){getParentOfKey=v}},1);
