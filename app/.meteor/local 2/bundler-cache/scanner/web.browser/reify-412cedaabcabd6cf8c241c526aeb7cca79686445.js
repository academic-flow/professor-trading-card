module.export({BaseForm:()=>BaseForm});let clone;module.link('lodash/clone',{default(v){clone=v}},0);let get;module.link('lodash/get',{default(v){get=v}},1);let omit;module.link('lodash/omit',{default(v){omit=v}},2);let setWith;module.link('lodash/setWith',{default(v){setWith=v}},3);let React,Component;module.link('react',{default(v){React=v},Component(v){Component=v}},4);let changedKeys;module.link('./changedKeys',{changedKeys(v){changedKeys=v}},5);let context;module.link('./context',{context(v){context=v}},6);let randomIds;module.link('./randomIds',{randomIds(v){randomIds=v}},7);
