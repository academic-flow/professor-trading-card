module.export({appendAffectedKey:()=>appendAffectedKey,dateToDateString:()=>dateToDateString,forEachKeyAncestor:()=>forEachKeyAncestor,getKeysWithValueInObj:()=>getKeysWithValueInObj,getLastPartOfKey:()=>getLastPartOfKey,getParentOfKey:()=>getParentOfKey,isEmptyObject:()=>isEmptyObject,isObjectWeShouldTraverse:()=>isObjectWeShouldTraverse,looksLikeModifier:()=>looksLikeModifier});module.link('./humanize.js',{humanize:"humanize"},0);function appendAffectedKey(affectedKey, key) {
    if (key === '$each')
        return affectedKey;
